...
class HealthAnalyticsService:
    ...
    async def analyze_trends(self, logs: List[dict]) -> dict:
        """
        Backward-compatible trend API used by /api/analysis/health-trends.
        Returns the full analysis payload so callers can render trends,
        alerts, recommendations, and risk score consistently.
        """
        return await self.analyze_health_data(logs)
