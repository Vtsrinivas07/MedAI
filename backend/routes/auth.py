...
async def register(user_data: UserCreate):
    ...
    user_dict = {
        ...
        # Self-registration is always patient; elevated roles must be assigned via admin workflows.
        "role": "patient",
        "is_active": True,
    ...
    # Generate tokens
    access_token = create_access_token({"sub": str(result.inserted_id), "email": user_data.email, "role": "patient"})
